...
tf.flags.DEFINE_string("input_file_pattern", "data/mscoco/tfrecord-data/val-?????-of-00004",
                       "File pattern of sharded TFRecord input files.")
tf.flags.DEFINE_string("checkpoint_dir", "data/mscoco/train",
                       "Directory containing model checkpoints.")
tf.flags.DEFINE_string("eval_dir", "data/mscoco/eval", "Directory to write event logs.")
